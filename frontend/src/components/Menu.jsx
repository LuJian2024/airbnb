  ...
  return (
    <div ref={ref} className="login-step-1">
      <div className="header1">
        <div style={{paddingTop:"22px",width:"118px",height:"64px"}} className="airbnb">
        ...
        <div className="air">
          ...
          <div className="login">
            <button style={{marginTop:"-9px",width:"86px",height:"48px",display:"flex",
        ...
        <div>
          ...
          <div className="drop">
            <div className="dropdownItem">
              ...
              <br />
              <button style={{borderBottom:"1px solid rgb(189, 185, 185)",
               width:"100%",paddingRight:"210px",paddingBottom:"20px"}}
                onClick={() => {
                  setHamburgerActive(false);
                  setLogin2Active(true);
                }}
              ...
              <button style={{paddingTop:"14px",borderRadius:"5px",width:"100%",paddingRight:"180px",paddingBottom:"15px"}}>
                Gift cards</button>
              <button style={{width:"100%",paddingRight:"109px",paddingTop:"10px",paddingBottom:"15px"}}>

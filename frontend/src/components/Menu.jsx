  ...
  return (
    <div ref={ref} className="login-step-1">
      <div className="header1">
        <div style={{top:"40px",}} className="airbnb">
        ...
        <div className="air">
          ...
          <div className="login">
            <button style={{width:"100px",height:"50px",display:"flex",justifyContent:"space-between",border:"1px solid rgb(189, 185, 185)",borderRadius:"50px"}}
              onClick={() => {
                setHamburgerActive(!hamburgerActive);}}>  
              <FontAwesomeIcon style={{position:"relative",top:"8px",fontSize:"17px",right:"-10px"}} icon={faBars} />
